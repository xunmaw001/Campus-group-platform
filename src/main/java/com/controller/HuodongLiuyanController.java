...
public class HuodongLiuyanController {
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huodongLiuyan !=null){
            ...
            BeanUtils.copyProperties( huodongLiuyan , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(huodongLiuyan.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody HuodongLiuyanEntity huodongLiuyan, HttpServletRequest request){
        ...
        if(false)
            ...
            huodongLiuyan.setHuodongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        else if("用户".equals(role))
            huodongLiuyan.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R update(@RequestBody HuodongLiuyanEntity huodongLiuyan, HttpServletRequest request){
...
//                            huodongLiuyanEntity.setHuodongId(Integer.valueOf(data.get(0)));   //组团活动 要改的
//                            huodongLiuyanEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
