    ...
    */
    ...
    public R save(@RequestBody HuodongCollectionEntity huodongCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            huodongCollection.setHuodongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        else if("用户".equals(role))
...
//                            huodongCollectionEntity.setHuodongId(Integer.valueOf(data.get(0)));   //组团活动 要改的
