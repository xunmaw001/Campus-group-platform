...
var centerMenu = [
    ...
    ,{
        name: '组团活动收藏',
        url: '../huodongCollection/list.html'
    }
    ,{
        name: '组团活动报名',
        url: '../huodongOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/xiaoyuanzutuanpingtai/admin/dist/index.html#/login";
