<template>
    <div style="backgroundImage: url('/xiaoyuanzutuanpingtai/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">校园组团平台注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="活动管理员姓名" class="input" v-if="tableName=='huodongguanliyuan'">
                            <el-input v-model="ruleForm.huodongguanliyuanName" autocomplete="off" placeholder="活动管理员姓名"  />
                        </el-form-item>
                        <el-form-item label="活动管理员手机号" class="input" v-if="tableName=='huodongguanliyuan'">
                            <el-input v-model="ruleForm.huodongguanliyuanPhone" autocomplete="off" placeholder="活动管理员手机号"  />
                        </el-form-item>
                        <el-form-item label="活动管理员身份证号" class="input" v-if="tableName=='huodongguanliyuan'">
                            <el-input v-model="ruleForm.huodongguanliyuanIdNumber" autocomplete="off" placeholder="活动管理员身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='huodongguanliyuan'">
                            <el-input v-model="ruleForm.huodongguanliyuanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.huodongguanliyuanName)&& 'huodongguanliyuan'==this.tableName){
                                this.$message.error('活动管理员姓名不能为空');
                                return
                            }
                             if('huodongguanliyuan' == this.tableName && this.ruleForm.huodongguanliyuanPhone&&(!this.$validate.isMobile(this.ruleForm.huodongguanliyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.huodongguanliyuanIdNumber)&& 'huodongguanliyuan'==this.tableName){
                                this.$message.error('活动管理员身份证号不能为空');
                                return
                            }
                            if('huodongguanliyuan' == this.tableName && this.ruleForm.huodongguanliyuanEmail&&(!this.$validate.isEmail(this.ruleForm.huodongguanliyuanEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
