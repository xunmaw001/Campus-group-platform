    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="huodongCollectionTypes">
                        <el-select v-model="ruleForm.huodongCollectionTypes" :disabled="ro.huodongCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in huodongCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="huodongCollectionValue">
                        <el-input v-model="ruleForm.huodongCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    huodongId: false,
                    yonghuId: false,
                    huodongCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    huodongId: '',
                    yonghuId: '',
                    huodongCollectionTypes: '',
                    insertTime: '',
                },
                huodongCollectionTypesOptions : [],
                huodongOptions : [],
                yonghuOptions : [],
                rules: {
                   huodongId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=huodong_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.huodongCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`huodongCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.huodongCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
