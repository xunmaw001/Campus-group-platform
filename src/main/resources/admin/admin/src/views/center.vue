  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='huodongguanliyuan'"  label='活动管理员编号' prop="huodongguanliyuanUuidNumber">
               <el-input v-model="ruleForm.huodongguanliyuanUuidNumber"  placeholder='活动管理员编号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='huodongguanliyuan'"  label='活动管理员姓名' prop="huodongguanliyuanName">
               <el-input v-model="ruleForm.huodongguanliyuanName"  placeholder='活动管理员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='huodongguanliyuan'"  label='活动管理员手机号' prop="huodongguanliyuanPhone">
               <el-input v-model="ruleForm.huodongguanliyuanPhone"  placeholder='活动管理员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='huodongguanliyuan'"  label='活动管理员身份证号' prop="huodongguanliyuanIdNumber">
               <el-input v-model="ruleForm.huodongguanliyuanIdNumber"  placeholder='活动管理员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='huodongguanliyuan'" label='活动管理员头像' prop="huodongguanliyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='huodongguanliyuan'"  label='电子邮箱' prop="huodongguanliyuanEmail">
               <el-input v-model="ruleForm.huodongguanliyuanEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 活动管理员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.huodongguanliyuanUuidNumber)&& 'huodongguanliyuan'==this.flag){
                             this.$message.error('活动管理员编号不能为空');
                             return
                         }

                         if((!this.ruleForm.huodongguanliyuanName)&& 'huodongguanliyuan'==this.flag){
                             this.$message.error('活动管理员姓名不能为空');
                             return
                         }

                             if( 'huodongguanliyuan' ==this.flag && this.ruleForm.huodongguanliyuanPhone&&(!isMobile(this.ruleForm.huodongguanliyuanPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.huodongguanliyuanIdNumber)&& 'huodongguanliyuan'==this.flag){
                             this.$message.error('活动管理员身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.huodongguanliyuanPhoto)&& 'huodongguanliyuan'==this.flag){
                             this.$message.error('活动管理员头像不能为空');
                             return
                         }

                             if( 'huodongguanliyuan' ==this.flag && this.ruleForm.huodongguanliyuanEmail&&(!isEmail(this.ruleForm.huodongguanliyuanEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
